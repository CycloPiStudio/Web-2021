...
const CACHE_NAME = "ProyectoCliente-cache";
const OFFLINE_URL = "ProyectoCliente.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["ProyectoCliente.html","ProyectoCliente.js","ProyectoCliente.wasm","ProyectoCliente.pck","ProyectoCliente.offline.html","ProyectoCliente.icon.png","ProyectoCliente.apple-touch-icon.png"];
